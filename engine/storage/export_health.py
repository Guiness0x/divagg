...
with open(export_file, "w") as file:
    ...
    file.write(divider + "\n")
    file.write("DIVAGG :: HEALTH EXPORT\n")
    file.write(divider + "\n\n")
...
print(divider)
print("DIVAGG :: HEALTH EXPORT")
print(divider)

print("\n[SUCCESS] Health export created:\n")
